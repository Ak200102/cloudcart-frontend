...
//           {/* Image Container */}
//           <div className="w-full sm:w-48 h-40 sm:h-48 flex-shrink-0 relative overflow-hidden bg-gray-50">
//             <div
//               onClick={handleProductDetails}
//               className="w-full h-full overflow-hidden cursor-pointer bg-white"
//             >
//               <img
//                 className="w-full h-full object-contain sm:object-cover transition-transform duration-500 ease-out hover:scale-105"
...
//                 <h3
//                   className="text-sm sm:text-lg font-semibold text-gray-900 uppercase tracking-wide cursor-pointer hover:text-gray-600 transition-colors duration-200 line-clamp-2 sm:line-clamp-none"
//                   onClick={handleProductDetails}
//                 >
//                   {item?.name}
//                 </h3>
...
//               {item?.description && (
//                 <p className="hidden sm:block text-gray-700 text-sm line-clamp-3 mb-4">
//                   {item.description}
//                 </p>
//               )}
//             </div>
...
//         <h3
//           className="text-sm font-medium text-gray-900 uppercase tracking-wide mb-2 cursor-pointer line-clamp-1 hover:text-gray-600 transition-colors duration-200"
//           onClick={handleProductDetails}
//         >
//           {item?.name}
//         </h3>
          ...
          <div className="flex-1 p-4 sm:p-6 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-start mb-2 gap-2">
                <h3
                  className="text-base sm:text-lg font-semibold text-gray-900 uppercase tracking-wide cursor-pointer hover:text-gray-600 transition-colors duration-200 flex-1"
                  onClick={handleProductDetails}
                >
                  {item?.name}
                </h3>
