                ...
                <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-5 h-full lg:items-center">
                  ...
                  >
                    <div className="relative max-w-xs sm:max-w-sm lg:max-w-lg w-full">
                      ...
                      {/* Image Container */}
                      <div className="relative  w-full h-full bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-sm rounded-3xl p-4 sm:p-6 lg:p-8 border border-gray-200/30">
                        <img
                          src={item?.image}
                          alt={`Banner ${index + 1}`}
                          className="w-full h-auto max-h-48 sm:max-h-64 lg:h-[450px] object-contain drop-shadow-2xl transform hover:scale-105 transition-transform duration-500"
                        />
                      </div>
